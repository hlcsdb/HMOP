...
'''REGEX STRINGS'''
SOUNDS = "(kʷ̓|kʷ|k̓|k|m̓|m|n̓|n|qʷ̓|qʷ|q̓|q|ch’|ch|hw|th|sh|lh|tth’|tth|ts’|ts|tl’|xw|x|l’|l|h|s|w’|w|y’|y|p’|p|t’|t|aa|ee|oo|ou|ii|o|u|i|e|a|’)"
...
#print(has_l_infixation('tsul’tsa’luqw','tsa’luqw'))
